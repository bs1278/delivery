    ...
    function add_questions(exam_id,i)
    {
        ...
        $("#num-question-btn").click(function(){
           ...
           $("#read-questions").show();
            ...
            //alert(count);
				console.log("quesion");
					console.log(document.forms["question-form"]["question"].value);
					console.log(document.forms["question-form"]["answer"].value);
            ...
            $   (".before").show();
                $("#question-display").hide();
					...
					success: function (data) {
					  if (data.is_taken) {
						alert("Your test is already completed this result won't be consider.");
					  }
					}
				  });
